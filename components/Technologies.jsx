      ...
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex flex-wrap -m-4 justify-around ali">
          {skills &&
            ...
            skills.map((category) => (
              <div className="p-2 lg:w-1/5  md:w-1/5 sm:w-1/2 w-full mb-2 text-center flex-col h-max">
                ...
                <nav className="flex flex-col text-center items-center -mb-1 space-y-2 ">
                  {category.objects.map((skill) => (
                    <div className="flex-inline flex text-center justify-center items-center ali">
                      {/* Renderizo el svg con la url de skill.image.url */}
                      <img
                        src={skill.image.url}
                        alt={skill.name}
                        className="w-6 h-6"
