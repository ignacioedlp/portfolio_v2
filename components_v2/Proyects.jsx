    ...
    <div className="flex flex-col items-center justify-center max-w-7xl my-9 md:my-0 md:h-screen container mx-auto font-montserrat" id='projects'>
      <div className="flex-col items-center text-center w-full justify-center ">
        ...
        <div className='flex justify-center items-center gap-3 text-[18px] md:text-[23px] uppercase font-bold'>
          <div>
            <p className=' text-rosewood'>All</p>
          </div>
          <div>
      ...
      <section className="text-gray-600 body-font h-2/3 flex justify-center mt-6 md:mt-0">
        <div className=" flex px-5 flex-col md:flex-row  items-center justify-center ">
          <div className=" md:w-1/2  mb-10 md:mb-0 ">
            <Image className="hidden md:block object-cover object-center rounded border-2 border-rosewood" alt="hero" src={proyects[currentProyect]?.image} width={630} height={454} />
            <Image className="md:hidden block object-cover object-center rounded border-2 border-rosewood" alt="hero" src={proyects[currentProyect]?.image} width={400} height={250} />
          ...
          <div className="lg:flex-grow md:w-1/2 md:p-5 flex flex-col md:items-start md:text-left items-center text-center ">
            <h1 className="text-black font-bold text-[43px]">{proyects[currentProyect]?.titleEn}</h1>
            <div className='h-[144px] md:w-[590px]'>
              <p className=" text-justify font-medium text-[20px] text-zinc-700">{proyects[currentProyect]?.description}</p>
            </div>
            ...
            <div className='flex justify-start gap-6 items-center text-[30px] text-rosewood mb-8'>
              {proyects[currentProyect]?.techs.map((tech) => (
                <div key={tech}>
            ...
            <div className="flex justify-center">
              <a className="flex text-center align-middle justify-center items-center text-seasalt bg-rosewood py-[10px] px-[46px] focus:outline-none rounded-[10px] text-[20px]" href={proyects[currentProyect]?.link}>Visit</a>
              <a className="ml-4 flex text-center align-middle justify-center items-center text-rosewood bg-seasalt border-2 border-rosewood py-[10px] px-[46px] focus:outline-none  rounded-[10px]  text-[20px] " href={proyects[currentProyect]?.link_github}>View proyect</a>
            </div>
          </div>
        </div>
      </section>
